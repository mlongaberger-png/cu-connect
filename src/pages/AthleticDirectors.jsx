...
import {
  ...
  ClipboardList, FileText, DollarSign, Settings, Users2, MapPin, Star, BarChart2
} from "lucide-react";
...
const TABS = [
  ...
  { id: "stats",         label: "Stats",         icon: BarChart2,     desc: "Upload & manage athlete stats" },
...
export default function AthleticDirectors() {
  ...
  return (
    <div className="h-full overflow-y-auto p-4 md:p-6 max-w-6xl mx-auto space-y-5">
      <div>
