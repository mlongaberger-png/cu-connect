...
import { Calendar, MapPin, Clock, Megaphone, Users, Trophy, UserCircle } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Welcome back! Here's everything about your kids' teams.</p>
      </div>
