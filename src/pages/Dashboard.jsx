...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      <PerformanceHero events={events} teams={teams} sports={sports} players={players} />
      ...
      {!isStaff && (
        <div className="grid grid-cols-2 gap-4">
          <StatCard label="Active Teams" value={teams.filter(t => t.is_active !== false).length} icon={Users} />
          <StatCard label="Upcoming Events" value={upcomingEvents.length} icon={Calendar} />
        </div>
      )}
